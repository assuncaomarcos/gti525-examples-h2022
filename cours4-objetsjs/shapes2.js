...
Il est fourni à titre informatif pour illustrer une technique pour réaliser l'héritage
 ...
 (une hiérarchie semblable à shapes.js est créée).

Fonctionnement:
- Nous modélisons chacun des trois objets, puis nous établissons la hiérarchie
 avec l'enchaînement des [[Prototypes]] via l'appel à Object.create
- Remarquez qu'il n'y a aucune fonction constructeur -- les [[Prototypes]] sont donc
enchaînés directement, et ne sont pas liés au champ "prototype" du constructeur
- La création d'une "instance" d'un des trois objets se fait également via l'appel
à Object.create: nous créons un nouvel objet, et son [[Prototype]] est
lié au [[Prototype]] de l'objet Point/Circle/Ellipse.
- Puisqu'aucun constructeur n'est invoqué lors de la création d'objets avec
Object.create, nous implémentons une fonction init dans chacun des objets, qui
permet d'initialiser les paramètres. L'utilisateur doit donc manuellement invoquer init
après avoir créé l'objet. Vous pouvez imaginer comme analogie l'initialisation
d'une "structure" en C++ vs une classe.
*/
